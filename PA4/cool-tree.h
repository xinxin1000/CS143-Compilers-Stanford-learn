...
public:
   ...
   virtual Symbol get_type(Class_ c) = 0;
...
public:
   ...
   Symbol get_typert(){return return_type;}
...
public:
   ...
   Symbol get_name(){return name;}
   void check_type(Class_ c);
   Symbol get_typedc(){return type_decl;}
...
public:
   ...
   Symbol get_typedc(){return type_decl;}
   Symbol get_type(Symbol s, Class_ c);
